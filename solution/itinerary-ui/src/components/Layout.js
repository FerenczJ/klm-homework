        ...
        <>
            ...
            <Card sx={airportsSelectorCardStyle} >
                <CardContent >
                    <Box display="flex" flexDirection="row">
                        ...
                        <Button variant="contained" disabled={selectedAirports.length < 2} startIcon={<AirplaneTicketIcon />} >Show price</Button>
                    </Box>
                    <AirportAutocomplete />
                    <AirportList />
                </CardContent>
            ...
            <Card sx={greetingCardStyle}>
                <CardContent >
                    ...
                    <Box color="primary.contrastText">An Airline that Flies Everywhere. A brand-new airline that wants to stand out by offering a great network with prices that are always the same, despite when or how you book.</Box>
                </CardContent>
            </Card >
                        ...
                        <Table sx={tableStyle}>
                            <TableBody>
                                <TableRow>
                                    ...
                                    <TableCell align="right"><Typography variant="h6" color="primary">12345 KM</Typography></TableCell>
                                </TableRow>
                                <TableRow >
                                    <TableCell align="left"><Typography fontSize={16} color="primary">Price</Typography></TableCell>
                                    <TableCell align="right"><Typography variant="h6" color="primary">12234$</Typography></TableCell>
                                </TableRow>
                                <TableRow >
                                    <TableCell align="left"><Typography fontSize={16} color="primary">Tax</Typography></TableCell>
                                    <TableCell align="right"><Typography variant="h6" color="primary">31$</Typography></TableCell>
                                </TableRow>
                                <TableRow sx={{ borderTop: "1px solid #072b45" }}>
                                    ...
                                    <TableCell align="right"><Typography variant="h6" color="primary">2222$</Typography></TableCell>
                                </TableRow>
                            </TableBody>
                        </Table>
                    </TableContainer>
